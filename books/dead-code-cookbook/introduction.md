...
デッドコードレシピは、実際のコードで示すため細かく定義する。そのため、デッドコードレシピで似ているものが存在する。似ているデッドコードレシピを **`🔖デッドコードパターン🔖`** として、本書ではパターンごとにデッドコードレシピを紹介する。また、デッドコードを作るために有用な部品を、 **`🔪デッドコードツール🔪`** として紹介する。
