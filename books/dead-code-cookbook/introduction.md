...
本書は、 **プログラミング経験者を対象とし、プログラミングの基礎についての説明は行わない** 。しかし、本書は特定のプログラミング言語に限定しないため、 **初心者でも分かる説明** で記載する。また、 **デッドコード自体は中級者以降では作りこむことはほとんどない** トピックスとなる。そのため、 **本書は習熟度によって違った楽しみ方** ができるだろう。

初心者： プログラミングにおける機能の確認。デッドコードというアンチパターンを通した、プログラミングスタイルの学習。
